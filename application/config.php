...
return [
    ...
    'http_exception_template' => [404 => APP_PATH."404.html", 401 => "401.html"],
    // +----------------------------------------------------------------------
    // | 异常及错误设置
    // +----------------------------------------------------------------------
    // 异常页面的模板文件
    'exception_tmpl' =>  APP_PATH.'common' . DS . 'view' . DS . 'tpl' . DS . 'think_exception.tpl' ,//APP_PATH.'common' . DS . 'view' . DS . 'tpl' . DS . 'think_exception.tpl'
    // 错误显示信息,非调试模式有效
    ...
    'captcha' => [
        // 验证码字符集合
        'codeSet' => '234',//5678abcdefhijkmnpqrstuvwxyzABCDEFGHJKLMNPQRTUVWXY
        // 验证码字体大小(px)
        'fontSize' => 18,
        // 是否画混淆曲线
        'useCurve' => false,
    ...
    'token' => [
        ...
        'type' => 'Mysql',
        // 缓存前缀
        'key' => 'uMoKSLJ7s4AaC2w1yz6Vvtxm39WcBdIh',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire' => 0,
